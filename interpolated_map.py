...
def main():
    parser = argparse.ArgumentParser(description="Create an interpolated bathymetric PNG using IDW.")
    ...
    output_path = args.output or default_output_path(args.input_csv, "_interpolated", ".png")
    ...
    plt.ylabel("Latitude")
    plt.title("Interpolated Bathymetric Map")
    plt.tight_layout()
